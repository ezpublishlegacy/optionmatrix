<?php
/**
 * File containing the optionMatrixDefinition class.
 *
...
/*!
  \class optionMatrixDefinition optionmatrixdefinition.php
  \ingroup eZDatatype
  \brief The class optionMatrixDefinition does

*/

class optionMatrixDefinition
{
    /*!
     Constructor
    */
    function optionMatrixDefinition()
    {
