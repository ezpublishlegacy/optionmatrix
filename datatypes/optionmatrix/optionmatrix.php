<?php
/**
 * File containing the optionMatrix class.
 *
...
/*!
  \class optionMatrix optionmatrix.php
  \ingroup eZDatatype
  \brief The class optionMatrix is a modification of the optionMatrix to add a dfault value.
...
class optionMatrix
{
    /*!
     Constructor
    */
    function optionMatrix( $name, $numRows = false, $matrixColumnDefinition = false  )
    {
        $this->Name = $name;
        $this->Matrix = array();
    ...
    */
    ...
    function decodeXML( $xmlString )
    {
        ...
        if ( $xmlString != "" )
        {
            ...
            $optionMatrixElement = $dom->documentElement;
            $typeValue = $optionMatrixElement->getAttribute( 'type_value' );
            $requiredValue = $optionMatrixElement->getAttribute( 'required_value' );
...
/*matrix*/
    ...
    */
    function xmlString( )
    {
        ...
        $root = $doc->createElement( "optionmatrix" );
        $root->setAttribute( "type_value", $this->typeValue );
        $doc->appendChild( $root );
        $root->setAttribute( "required_value", $this->requiredValue );
        $doc->appendChild( $root );
    ...
    function setRequiredValue( $value )
    {
